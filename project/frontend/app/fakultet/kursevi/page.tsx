...
const KurseviPage = () => {
	...
	const onJoinCourse = async (id: string) => {
		try {
			await joinCourse(id);
			handleApiSuccess('Ulazak na kurs uspjesan!');
		} catch (error) {
	...
	const onCreate = async (data: any) => {
		try {
			...
			handleApiSuccess('Kreiranje kursa uspjesno!');
		} catch (error) {
	...
	const onEdit = async (data: any) => {
		try {
			...
			handleApiSuccess('Apdejtovanje kursa uspjesno!');
		} catch (error) {
	...
	const onDelete = async (id: string) => {
		try {
			...
			handleApiSuccess('Brisanje kursa uspjesno!');
		} catch (error) {
